...
# Copy agents into the package for distribution. Like the skills below, they
# live in the Go module so the Go CLI can embed them into its binary.
src_agents = repo_dir / "src" / "go" / "bartleby" / "agents"
